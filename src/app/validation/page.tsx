...
export default function Validation () {
  ...
  useEffect(() => {
    if (!influencer || !influencer.register_complete) {
      return
    }
      ...
      <Card>
        ...
        <CardBody>
          <div className='w-96 px-4 flex flex-col gap-5'>
            <p>¡Hola!</p>
            <p>Gracias por registrarte para trabajar como influencer en Foodllowers. Queremos informarte que hemos recibido tus datos y actualmente están siendo validados por nuestro equipo.</p>
            ...
            <p>Agradecemos tu interés en trabajar con nosotros y esperamos poder darte la bienvenida a nuestro equipo de influencers muy pronto.</p>
