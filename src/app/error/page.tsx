      ...
      <Card className='w-96'>
        ...
        <CardBody>
          <div className='px-4 flex flex-col gap-5'>
            ...
            <p>Lamentamos informarte que el acceso a esta aplicación está restringido únicamente a los creadores de contenido de la plataforma Foodllowers. Si no eres un creador de contenido, no podrás acceder a esta página.</p>
